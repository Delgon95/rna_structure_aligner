...
public class AlignerOutput {
  ...
  AlignerOutput(int _aligned, final ArrayList<Integer> _referenceIndexes,
      final ArrayList<Integer> _targetMapping, final Superimposer _superimposer,
      final long _processingTime, final double _rmsd) {
    super();
    aligned = _aligned;
