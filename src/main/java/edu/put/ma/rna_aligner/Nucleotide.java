...
public class Nucleotide {
	...
	public Nucleotide(final ArrayList<Coordinates> _representatives, final String code, final String key) {
	...
	public static ArrayList<Coordinates> NucleotidesToListMapped(final ArrayList<Nucleotide> nucleotides,
			final int[] map, boolean primary) {
		ArrayList<Coordinates> result = new ArrayList<Coordinates>();
		if (primary) {
			// If map[i] == 1, take it.
